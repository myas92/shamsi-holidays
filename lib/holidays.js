...
var isHolidaysOnline = function (date) { return __awaiter(void 0, void 0, void 0, function () {
    var status, year, month, day, dayOfHolidays, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                day = date ? moment(date, 'jYYYY/jMM/jDD').format('jD') : moment().format('jD');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, exports.requestToTime)({ month: month, year: year })];
...
var isHolidaysOffline = function (date) { return __awaiter(void 0, void 0, void 0, function () {
    var status, year, month, day;
    return __generator(this, function (_a) {
        year = date ? moment(date, 'jYYYY/jMM/jDD').format('jYYYY') : moment().format('jYYYY');
        month = date ? moment(date, 'jYYYY/jMM/jDD').format('jM') : moment().format('jM');
        day = date ? moment(date, 'jYYYY/jMM/jDD').format('jD') : moment().format('jD');
        // This import style requires "esModuleInterop", see "side notes"
        // let dayOfHolidays =  require('./.json');  // This import style requires "esModuleInterop", see "side notes"
        // console.log(dayOfHolidays);
